...
//         const ExpiryDate = vehicleData?.expiry_date;
...
//             expiry_date: vehicleData?.expiry_date || null,
...
const VehicleDetailsModal = ({ open, onClose, lead }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axioslogin.post("/customer/create-vehicle", payload);
            const { success, message } = response.data;
            ...
            console.log({ error });
            warningNotify(error?.response?.data?.message || "Error creating vehicle");
        } finally {
            setLoading(false);
        }
    };
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Form container using Box + flex instead of Grid */}
                    <Box
                        sx={{
                            position: "relative",
                            zIndex: 1,
                    ...
                    >
                        ...
                        >
                            {/* Each field gets responsive width similar to Grid xs=12, md=6 */}
                            <Box
                                sx={{
                                    width: { xs: "100%", md: "40%" },
                                }}
