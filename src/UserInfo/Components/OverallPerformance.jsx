...
const renderStars = (score, isDark = false) => {
    const stars = [];
    ...
    for (let i = 0; i < emptyStars; i++) {
        stars.push(<StarOutlineIcon key={`empty-${i}`} style={{ color: isDark ? "#475569" : "#cbd5e1", fontSize: 15 }} />);
    }
    return stars;
};
        ...
        >
            <Box>
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
                    ...
                    <Avatar size="sm" sx={{ bgcolor: isDark ? "rgba(167, 139, 250, 0.15)" : "rgba(124, 58, 237, 0.08)", color: isDark ? "#c084fc" : "#7c3aed", width: 28, height: 28 }}>
                ...
                <Stack spacing={1.5}>
                    ...
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
                            <Typography level="body-xs" sx={{ color: isDark ? "#94a3b8" : "neutral.550", fontWeight: 800, textTransform: "uppercase", fontSize: "9px" }}>
                                Overall Rating Score
                            </Typography>
                            <Typography level="body-xs" sx={{ color: isDark ? "#c084fc" : "#7c3aed", fontWeight: 900 }}>
                                {overallScore > 0 ? `${overallScore} / 5.0` : "0.0 / 5.0"}
                            </Typography>
                        </Box>
                        <Box sx={{ display: "flex", gap: "3px" }}>
                            {renderStars(overallScore, isDark)}
                        </Box>
                    </Box>
                    ...
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                            ...
                            <Typography level="body-xs" sx={{ color: isDark ? "#34d399" : "#10b981", fontWeight: 900 }}>
                                {conversionRate.toFixed(1)}% ({overallStats.soldCount} / {overallStats.total})
                            </Typography>
                        </Box>
                        <Box sx={{ width: "100%", height: "6px", bgcolor: isDark ? "#0f172a" : "#f1f5f9", borderRadius: "3px", overflow: "hidden" }}>
                    ...
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                            ...
                            <Typography level="body-xs" sx={{ color: isDark ? "#60a5fa" : "#3b82f6", fontWeight: 900 }}>
                    ...
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                            ...
                            <Typography level="body-xs" sx={{ color: isDark ? "#f87171" : "#ef4444", fontWeight: 900 }}>
