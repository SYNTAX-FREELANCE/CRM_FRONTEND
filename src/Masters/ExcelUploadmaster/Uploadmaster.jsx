          ...
          if (success === 1) {
            if (type === "customer") {
              ...
              setVehicle({
                ...
                rto: data.rto || "",
                registration_data: formatDate(data.registration_data),
                model: data.model || "",
      ...
      navigate("/home/setting/commonview", {
        state: {
          ...
          columns: [
            ...
            { field: "customer_id", headerName: "Cust ID", width: 80, flex: 0.3 },
            ...
            { field: "registration_data", headerName: "Reg Date", width: 120, flex: 0.5 },
